          ...
          <div className="space-y-6">
            ...
            <div className="card">
              <div className="flex items-center gap-3 mb-1">
                ...
                <h2 className="text-base font-semibold text-gray-900">Sign Out All Other Devices</h2>
              </div>
              <p className="text-sm text-gray-500 mb-4">
                Immediately invalidates all active sessions except this one — including any browser that has your password saved. Use this if you suspect your credentials were used without your permission.
              </p>
              <button
